...
<script src="js/jquery-3.5.4.min.js"></script>
    <!-- Bootstrap CSS -->
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0" data-aos="fade-up" data-aos-delay="100">
            <div class="icon-box">
              <div class="icon"><div>Iconos diseñados por <a href="https://www.flaticon.es/autores/dave-gandy" title="Dave Gandy">Dave Gandy</a> from <a href="https://www.flaticon.es/" title="Flaticon">www.flaticon.es</a></div></div>
    ...
    <section id="why-us" class="why-us">
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-lg-5 align-items-stretch video-box" style='background-image: url("{{ asset('img/why-us.jpg') }}");' data-aos="fade-right">
